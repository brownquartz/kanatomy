...
漢字の分解・組み立て検索ツール（旧 kanji-dict）。

2026-08、辞書機能を [meanji](https://github.com/brownquartz/meanji) として分離。
kanatomy は CJKVI-IDS(GPLv2)由来の部品分解データに依存する機能のみを持つ。
meanji はこのデータに一切依存しない、クリーンなライセンスの辞書データのみで構成。
